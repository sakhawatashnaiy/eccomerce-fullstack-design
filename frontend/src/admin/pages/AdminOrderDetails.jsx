...
import { useGetAdminOrderByIdQuery, usePatchAdminOrderMutation } from '../../services/apiSlice.js'
...
export default function AdminOrderDetails() {
	...
	const { data: order, isLoading, isError, error, refetch } = useGetAdminOrderByIdQuery(id)
